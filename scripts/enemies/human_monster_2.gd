...
@export var dist_attack_melle := 20
var distance := 0.0
...
const ARM_scene = preload("res://scenes/enemies/bullet.tscn")  # Using the correct projectile scene
...
func spell_attack1() -> void:
	...
	spell_attack1_instance.global_position.y += 5
